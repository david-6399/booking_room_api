        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm cursor-pointer hover:scale-105 duration-200 ease-in" wire:click='showHostelOwner()'>
                        <div class="flex items-center justify-between" >
                            <div>
                                <p class="text-sm text-gray-500">Show Hostel Owners</p>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div class="relative flex-1 max-w-md">
                                <input type="text" placeholder="Search bookings..."
                                    class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none" wire:model.live='search'>
                            ...
                            <div class="flex items-center space-x-3">
                                <select
                                    class="px-4 py-2.5 border-2 border-gray-700 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none font-bold"
                                    wire:model.live='perUserStatus'>
                                ...
                                <select
                                    class="px-4 py-2.5 border-2 border-green-700 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none font-bold text-green-700"
                                    wire:model.live='perHostelStatus'>
                                ...
                                <select
                                    ...
                                    wire:model.live='perEmailStatus'>
                                    <option value ="">Email Verifies</option>
                                ...
                                @foreach ($users as $user)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-gray-600">
                                            {{ $user->email }}</td>
                                        <td class="px-6 py-4 text-gray-600">
                                            {{ $user->phone ?? 'No Phone Number !' }}</td>
                                        <td class="px-6 py-4 text-gray-600">
                                            {{$user->hostel ? 'True' : 'False'}}</td>
                                        <td class="px-6 py-4 text-gray-600">
                                            {{$user->email_verified_at ? 'Verified' : 'Not Verified'}}</td>
                                        
                                        <td class="px-6 py-4">
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ">status</span>
                                        </td>
                        ...
                        <div class="flex items-center space-x-2">
                            <button wire:click='previousPage' wire:loading.attr='disabled'
                                @class([
                                    ...
                                    'border-gray-200 text-gray-400 cursor-not-allowed' => $users->onFirstPage(),
                                    'border-gray-200 text-gray-700 hover:bg-gray-50' => !$users->onFirstPage(),
                    ...
                    {{ $users->currentPage() == $page
                        ...
                        : 'border border-gray-200 text-gray-700 hover:bg-gray-50' }}">{{ $page }}
                            ...
                            <button wire:click="nextPage" wire:loading.attr="disabled" @class([
                                'p-2 rounded-lg border transition-colors',
                                'border-gray-200 text-gray-400 cursor-not-allowed' => !$users->hasMorePages(),
                                'border-gray-200 text-gray-700 hover:bg-gray-50' => $users->hasMorePages(),
                            ])
