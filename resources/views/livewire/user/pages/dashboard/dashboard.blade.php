      ...
      <header class="sticky top-0 z-30 bg-white shadow-sm">
        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <div class="relative">
            ...
            <div id="user-menu" class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-2 hidden">
              ...
              <a href="../login.html" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-50">Logout</a>
            </div>
          </div>
        </div>
      </header>
            ...
            <table class="w-full">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-900">Private Double Room</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 22, 2024</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 25, 2024</td>
                  <td class="px-6 py-4">
                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">Confirmed</span>
                  </td>
                  <td class="px-6 py-4 text-sm font-medium text-gray-900">$145</td>
                  <td class="px-6 py-4">
                ...
                <tr class="hover:bg-gray-50">
                  <td class="px-6 py-4">
                    <div class="flex items-center space-x-3">
                      ...
                      <div>
                        <p class="font-medium text-gray-900">Maria Johnson</p>
                        <p class="text-sm text-gray-500">maria@example.com</p>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 text-sm text-gray-900">Standard Dorm Room</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 23, 2024</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 26, 2024</td>
                  <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4 text-sm font-medium text-gray-900">$85</td>
                  <td class="px-6 py-4">
                    <button class="text-gray-400 hover:text-gray-600">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4 text-sm text-gray-900">Deluxe Family Suite</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 24, 2024</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 28, 2024</td>
                  <td class="px-6 py-4">
                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">Confirmed</span>
                  </td>
                  <td class="px-6 py-4 text-sm font-medium text-gray-900">$350</td>
                  <td class="px-6 py-4">
                    <button class="text-gray-400 hover:text-gray-600">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
                ...
                <tr class="hover:bg-gray-50">
                  <td class="px-6 py-4">
                    <div class="flex items-center space-x-3">
                      ...
                      <div>
                        <p class="font-medium text-gray-900">Emily Lee</p>
                        <p class="text-sm text-gray-500">emily@example.com</p>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 text-sm text-gray-900">Female Dorm Room</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 21, 2024</td>
                  <td class="px-6 py-4 text-sm text-gray-500">Dec 22, 2024</td>
                  <td class="px-6 py-4">
                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-700">Completed</span>
                  </td>
                  <td class="px-6 py-4 text-sm font-medium text-gray-900">$32</td>
                  <td class="px-6 py-4">
                    <button class="text-gray-400 hover:text-gray-600">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
